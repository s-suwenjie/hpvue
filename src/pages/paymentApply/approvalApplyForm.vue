...
export default {
  ...
  data () {
    return {
      tabState:[{select:true},{select:false},{select:false},{select:false},{select:false},{select:false},{select:false},{select:false},{select:false}],
      eventShowA: true,
      branchShow:true,
      eventShowB: false,
      remark: '',
    ...
    initData(){
      ...
      this.init({
        ...
        look: (data) => {
          ...
          if(this.nature === '7'){
            this.tabState=[{select:true},{select:false},{select:false},{select:false},{select:false},{select:false},{select:false},{select:false},{select:false}]
            let id=''
