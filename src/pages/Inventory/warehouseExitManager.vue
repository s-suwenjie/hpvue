...
<!--      </template>-->
      ...
      <template #listHead>
        ...
        <yhm-managerth title="经办人" value="personID"></yhm-managerth>
        <yhm-managerth style="width: 120px;" title="出库日期" value="workDate"></yhm-managerth>
        <yhm-managerth style="width: 100px;" title="出库编号" value="code"></yhm-managerth>
  ...
  export default {
    ...
    methods:{
      ...
      initPageData (initValue) {
        ...
        this.init({
          initValue: initValue,
          url: '/Basic/getWarehouseExitManager',
          data: params,
          all: (data) => {
            // 不管是不是初始化都需要执行的代码
