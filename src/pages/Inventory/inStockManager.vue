...
<!--        <yhm-managerth style="width: 40px;" title="查看"></yhm-managerth>-->
        <yhm-managerth title="品牌" value="name"></yhm-managerth>
        <yhm-managerth style="width: 200px;" title="商品型号" value="modelID"></yhm-managerth>
        <yhm-managerth style="width: 150px;" title="单价" value="price"></yhm-managerth>
        <yhm-managerth style="width: 100px" title="数量" value="quantity"></yhm-managerth>
        <yhm-managerth style="width: 150px;" title="总价值" value="money"></yhm-managerth>
