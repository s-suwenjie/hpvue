  ...
  export default {
    ...
    methods: {
      ...
      drawChart () {
        ...
        let myChart = this.$echarts.init(document.getElementById("cartogram"));
        // 指定图表的配置项和数据
        let option = {
          color: ['#3398DB'],
          tooltip: {
          ...
          toolbox: {
            ...
            feature: {
              ...
              saveAsImage: { show: true, name:'支付续保费' + " " + that.downloadTime},
          ...
          call: (data) => {
            ...
            setTimeout(()=>{
              ...
              if(Number(monthMax)<10){//金额最大值的 日期
                if(((monthMax).toString()).indexOf('0')==-1){
                  monthMax = '0'+monthMax
                }else{
                  monthMax = monthMax
                }
