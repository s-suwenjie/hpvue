...
<script>
  ...
  export default {
    ...
    created () {
      ...
      this.setQuery2Value('insuredUnitShowName')
      this.setQuery2Value('billingOwID')
      this.setQuery2Value('cashierSubject')
      this.setQuery2Value('cashierSubjectID')
      this.setQuery2Value('discountMoney')
      this.setQuery2Value('billingID')
      this.setQuery2Value('remake')
      this.setQuery2Value('newNature')
      ...
      this.init({
        ...
        add: (data) => {
          ...
          this.remark=this.remake
          this.otherAccount=this.insuredUnitAccount
          this.otherAccountID=this.insuredUnitAccountID
          this.otherUnitID=this.insuredUnitID
          this.otherUnit=this.insuredUnitShowName
          this.showPayment()
          this.id=this.billingID
        },
        look: (data) => {
        ...
        if(this.nature === '4'){
          if(this.otherAccountID){
            this.$dialog.OpenWindow({
              ...
              height: '692',
              title: '选择收支明细',
              url: '/selectBankDetail?direction=1&categoryBefore=1',
              closeCallBack: (data)=>{
                if(data){
                                ...
                                if (data.type === 0) {
                                  ...
                                  this.ajaxJson({
                                    ...
                                    call: (data) => {
                                      ...
                                      let params = {
                                        id:this.billingID,
                                        ownerID:this.billingOwID
                                      }
                                      this.ajaxJson({
                                        url: '/Fin/modifyBankDetailCollect',
                                        data: params,
                                        call: (data)=>{
                                          if(data){
                                          }
