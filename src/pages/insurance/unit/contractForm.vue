  ...
  <div class="f_main f_main_customize">
    <yhm-formbody>
      ...
      <template #control>
        ...
        <yhm-form-radio v-if="false" title="合同" subtitle="收付款项" :select-list="paymentItemsList" :value="paymentItems" id="paymentItems" rule="R0000" ></yhm-form-radio>
        <yhm-form-text v-if="false" placeholder=""  title="总金额" subtitle=""  :value="totalMoney" id="totalMoney" :rule="totalMoney==''?'':'R1501'" ></yhm-form-text>
...
<script>
  ...
  export default {
    ...
    created () {
      ...
      if (this.unitID!=''){
        this.customersID=this.unitID
        this.customers=this.unit
        this.insuredState = '1'
