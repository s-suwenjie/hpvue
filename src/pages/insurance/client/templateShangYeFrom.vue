<template>
  <div>
    <div class="center">
      ...
      <div class="flex" style="width: 630px">

        <span>以当日报价为准 支持转账出单</span>
        <input  placeholder="备注:没有可不写" style="width: 400px" type="text" v-model="remark">
      </div>
...
<script>
  ...
  export default {
    ...
    methods:{
      previewCall(){
        this.previewValue='特斯拉授权钣喷中心姚家园店（'+this.name+'）为您{'+this.plate+'}车报价  商业险金额：'+this.businessMoney+'（'+this.businessCategory+'） '+this.insuranceUnit+'现金优惠：'+this.discountMoney+' 实收金额：'+this.netReceiptsMoney+' '+this.give+' 联系电话：'+this.contactPhone+' 以当日报价为准 支持转账出单 '+this.remark+' 详情戳https://dllzff.cn/xdyofk15 “回T退订”',
