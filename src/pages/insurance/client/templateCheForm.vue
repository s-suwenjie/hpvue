...
<script>
  ...
  export default {
    ...
    methods:{
      previewCall(){
        this.previewValue='特斯拉授权钣喷中心姚家园店（'+this.name+'）为您{'+this.plate+'}车报价 交强险金额：'+this.jiaoqiangMoney+' 联系电话：'+this.contactPhone+' 以当日报价为准 支持转账出单 '+this.remark+' 详情戳https://dllzff.cn/xdyofk15 “回T退订”',
