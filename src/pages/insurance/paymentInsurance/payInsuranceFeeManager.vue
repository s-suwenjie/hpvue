        ...
        <div class="listTotalCrente m_list w620">
          ...
          <table width="100%" cellpadding="0" cellspacing="0" class="m_content_table m_content_total_table">
            ...
            <tr>
              ...
              <yhm-managerth style="width: 100px;" before-color="#49a9ea" title="" before-title="已付保险总金额"></yhm-managerth>
              <yhm-managerth style="width: 100px;" before-color="#49a9ea" title="" before-title="未付保险总金额"></yhm-managerth>
            </tr>
            </thead>
            <tbody>
            <tr>
  ...
  export default {
    ...
    methods:{
        ...
        this.ajaxJson({
          ...
          call:(data) =>{
            if(data.type===0){
              ...
              this.ajaxJson({
                url: '/Insurance/PayInsuranceFeeTotal',
                data: paramsFinish,
                call:(information) =>{
      ...
      initPageData (initValue) {
        ...
        this.init({
          initValue:initValue,
          url: '/Insurance/PayInsuranceFeeManager',
          data:params,
          all:(data) =>{
