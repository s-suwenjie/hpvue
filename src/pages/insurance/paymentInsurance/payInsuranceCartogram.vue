...
<script>
  ...
  export default {
    name: 'payInsuranceCartogram.vue',
    mixins: [formmixin],
    data(){
      return{
        colors:'#fd6802',//----新加---
            ...
            if(this.month!=='13'){
              ...
              if(this.month<10){
                if(day[money.indexOf(maxSchedule)]<10){
                  this.dateMax = this.year + '年0' + this.month + '月0' + day[money.indexOf(maxSchedule)] + '日'
                }else{
                  this.dateMax = this.year + '年0' + this.month + '月' + day[money.indexOf(maxSchedule)] + '日'
                }

              }else{
                if(day[money.indexOf(maxSchedule)]<10){
                  this.dateMax = this.year + '年' + this.month + '月0' + day[money.indexOf(maxSchedule)] + '日'
                }else{
              ...
              if(this.month<10){
                if(day[money.indexOf(maxSchedule)]<10){
                  this.dateMin = this.year + '年0' + this.month + '月0' + day[money.indexOf(minSchedule)] + '日'
                }else{
                  this.dateMin = this.year + '年0' + this.month + '月' + day[money.indexOf(minSchedule)] + '日'
                }

              }else{
                if(day[money.indexOf(maxSchedule)]<10){
                  this.dateMin = this.year + '年' + this.month + '月0' + day[money.indexOf(minSchedule)] + '日'
                }else{
