<template>
  <div class="f_main">
    <yhm-formbody>
      ...
      <template #control>
        <yhm-form-select  title="负责人" tip="value" @click="principalEvent" :value="principal" id="principal" ></yhm-form-select>
    ...
    <yhm-formbody>
      ...
      <template #control>
        ...
        <yhm-form-date title="交强险" subtitle="到期日"  :value="forceEndDate" id="forceEndDate " position="u"></yhm-form-date>
