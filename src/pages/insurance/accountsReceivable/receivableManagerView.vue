...
<!--            <yhm-radiofilter @initData="initChooses('writeOffType')" title="核销类型" :content="writeOffTypeList"></yhm-radiofilter>-->
              <yhm-radiofilter @initData="initChoose('isFinish')" title="状态" :content="isFinishList"></yhm-radiofilter>
        ...
        <template #listHead>
          ...
          <yhm-managerth style="width:100px" title="剩余欠款金额"></yhm-managerth>
...
<!--            <yhm-manager-td-center :value="item.isFinish=='0'?'待收款':''" ></yhm-manager-td-center>-->
            <yhm-manager-td-operate>
              ...
              <yhm-manager-td-operate-button @click="registerEvent(item)" v-show="item.isFinish==2" value="查看登记信息" icon="i-btn-applicationSm" color="#333"></yhm-manager-td-operate-button>
            </yhm-manager-td-operate>
          </tr>
        </template>
      ...
      initData (initValue) {
        ...
        this.init({
          ...
          all:(data) =>{
            ...
            this.isFinishList = data.isFinishList
