<template>
  <div class="f_main">
    ...
    <yhm-view-tab>
      <template #tab>
        <yhm-view-tab-button :list="tabState" :index="0" @click="listDetail">往来明细</yhm-view-tab-button>
      </template>
      <template #tab_total>
        <div v-show="tabState[0].select" style="background: #c5daeb;margin-right: 2px;">
