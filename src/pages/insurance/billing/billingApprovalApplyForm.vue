  ...
  <div class="f_main">
    ...
    <yhm-formoperate :createName="createName" :insertDate="insertDate" :updateName="updateName" :updateDate="updateDate">
      <template #btn v-if="isBtn">
        ...
        <yhm-commonbutton value="保存并提交" class="btnAddSave" :flicker="true" icon="btnSubSave" @call="btnSubSave()" category="one"></yhm-commonbutton>
      </template>
    </yhm-formoperate>
  </div>
</template>
