  ...
  <div>
    <yhm-managerpage category="1">
      ...
      <template #navigationTab>
        ...
        <router-link class="menuTabDiv menuTabActive" :to="{path:'/home/unionCostsManager'}">工会审批制定</router-link>
