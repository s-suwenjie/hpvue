  ...
  <div class="f_main">
    <yhm-view-body>
      ...
      <template #body>
        ...
        <yhm-view-control title="负责人" :content="chargePerson" ></yhm-view-control>
        <yhm-view-control title="所属客户" :content="customers" ></yhm-view-control>
        <yhm-view-control title="合同所属类型" :content="format" :psd="formatList"></yhm-view-control>
        ...
        <yhm-view-control title="签署时间" :content="startTime" type="date"></yhm-view-control>
