<template>
  <div class="f_main">
    <!--<yhm-schedule  :config="scheduleConfig" :psd="approveFlowsItemList"></yhm-schedule>-->
    <yhm-view-body>
      ...
      <template #body>
        ...
        <yhm-view-control title="业务类型" :content="businessType" :psd="businessTypeList"></yhm-view-control>
      </template>
    </yhm-view-body>
