<template>
  <div class="f_main">
    ...
    <yhm-formbody>
      ...
      <template #control>
        <yhm-form-date placeholder=""  :no-edit="!isAmount" title="签收日期" v-if="isWorkDate" subtitle="" :value="workDate" id="workDate" rule="R0000"></yhm-form-date>
        <yhm-form-date placeholder="":no-edit="isAmount" title="寄出日期" v-else  subtitle="" :value="workDate" id="workDate" rule="R0000"></yhm-form-date>
        ...
        <yhm-form-text no-edit="1" placeholder=""  title="序号" subtitle="" :value="number" id="number"></yhm-form-text>
        <yhm-form-radio :no-edit="isBusin"  width="1" title="业务类型" @call="businessTypeCall()" :select-list="businessTypeList" :value="businessType" id="businessType" ></yhm-form-radio>
      </template>
    </yhm-formbody>
    ...
    <yhm-formbody>
      ...
      <template #control>
        <yhm-form-text placeholder="直接录入或者点击后面图标选择公司"  title="公司名称" subtitle="" :value="unit" id="unit" @blur="verificationUnit(0)">
        ...
        <yhm-form-text-search title="寄件人" :key="searchKey"  v-if="isWorkDate"  placeholder="直接录入或者点击后面图标选择" :value="otherPartyPersonName" :search-table-list="searchTableList" @additionClick="addClick" @searchClick="searchClick" @keydown="searchKeyDown" after-icon="icon-search" :search-loading="searchLoading" id="otherPartyPersonName" :search-list="searchList" search-list-key="name" rule="R0000">
          <div class="formBoxIcon" @click="recipientClick">
            <svg t="1602226869435"  class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="2092" width="30" height="30" style="margin: auto;"><path d="M502.2 393.6m-163 0a163 163 0 1 0 326 0 163 163 0 1 0-326 0Z" fill="#AED7FF" p-id="2093"></path><path d="M197.5 363.4c0.1-1.4 0.2-2.7 0.3-4.1 12-147.5 137.4-263.1 285.6-263.1 151.5 0 275.8 118.2 285.9 267.2h20c-10-160-143.3-287.2-305.9-287.2-158.5 0-292.7 123.6-305.5 281.4-0.2 1.9-0.3 3.8-0.4 5.7h20zM768.1 414.9c-16 142.9-137.6 254.4-284.7 254.4s-268.6-109-284.7-254.4h-20.1c16.3 156.6 146.7 274.4 304.8 274.4 158.2 0 288.7-120.4 304.8-274.4h-20.1z" fill="#108EE9" p-id="2094"></path><path d="M483.4 160.3c-122.7 0-222.5 99.8-222.5 222.5s99.8 222.5 222.5 222.5 222.5-99.8 222.5-222.5c-0.1-122.7-99.9-222.5-222.5-222.5z m0 407.4c-102.1 0-184.9-82.8-184.9-184.9 0-102.1 82.8-184.9 184.9-184.9s184.9 82.8 184.9 184.9c0 102.1-82.8 184.9-184.9 184.9z" fill="#108EE9" p-id="2095"></path><path d="M483.4 510.7c-70.5 0-127.9-57.4-127.9-127.9s57.4-127.9 127.9-127.9 127.9 57.4 127.9 127.9-57.4 127.9-127.9 127.9z m0-209.3c-44.9 0-81.4 36.5-81.4 81.4s36.5 81.4 81.4 81.4c44.9 0 81.4-36.5 81.4-81.4s-36.6-81.4-81.4-81.4z" fill="#108EE9" p-id="2096"></path><path d="M433.2 563.8c0-51.5-0.2-103.1 0.1-154.6 0.2-36.1 18-57 48.2-57.2 32.1-0.2 54 22.6 54.2 57.8 0.4 57.4 0 114.8 0.2 172.2 0.1 30.5 7 38 39.5 40.9 65.3 5.7 130.6 11.1 195.9 16 41.3 3.1 57.7 20.5 49.6 58.2-16.4 76.4-34.4 152.6-51.1 228.9-4.5 20.8-18.2 30.5-39.7 31.4-29.5 1.3-59.1 2-88.7 2.1-83.2 0.3-166.4 0.2-249.6 0-32.3 0-42.7-6.7-52.8-34.7-27.9-77.3-55.5-154.7-83.2-232-8.1-22.5 4-47.3 27.4-56 22.2-8.2 52.7 2.8 62.4 24.2 11 24.4 21 49.3 30.1 74.3 5.4 14.8 13.6 26.7 31.6 24 19.2-3 26.3-16.8 26.2-34.4-0.5-53.7-0.4-107.4-0.3-161.1z" fill="#1195FE" p-id="2097"></path></svg>
          </div>
        </yhm-form-text-search>
        <yhm-form-text-search title="收件人" @blur="nameBlue()" @change="delChange" :key="searchKey"  v-else placeholder="直接录入或者点击后面图标选择" :value="otherPartyPersonName" :search-table-list="searchTableList" @additionClick="addClick" @searchClick="searchClick" @keydown="searchKeyDown" after-icon="icon-search" :search-loading="searchLoading" id="otherPartyPersonName" :search-list="searchList" search-list-key="name" rule="R0000">
          <div class="formBoxIcon" @click="recipientClick">
            <svg t="1602226869435"  class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="2092" width="30" height="30" style="margin: auto;"><path d="M502.2 393.6m-163 0a163 163 0 1 0 326 0 163 163 0 1 0-326 0Z" fill="#AED7FF" p-id="2093"></path><path d="M197.5 363.4c0.1-1.4 0.2-2.7 0.3-4.1 12-147.5 137.4-263.1 285.6-263.1 151.5 0 275.8 118.2 285.9 267.2h20c-10-160-143.3-287.2-305.9-287.2-158.5 0-292.7 123.6-305.5 281.4-0.2 1.9-0.3 3.8-0.4 5.7h20zM768.1 414.9c-16 142.9-137.6 254.4-284.7 254.4s-268.6-109-284.7-254.4h-20.1c16.3 156.6 146.7 274.4 304.8 274.4 158.2 0 288.7-120.4 304.8-274.4h-20.1z" fill="#108EE9" p-id="2094"></path><path d="M483.4 160.3c-122.7 0-222.5 99.8-222.5 222.5s99.8 222.5 222.5 222.5 222.5-99.8 222.5-222.5c-0.1-122.7-99.9-222.5-222.5-222.5z m0 407.4c-102.1 0-184.9-82.8-184.9-184.9 0-102.1 82.8-184.9 184.9-184.9s184.9 82.8 184.9 184.9c0 102.1-82.8 184.9-184.9 184.9z" fill="#108EE9" p-id="2095"></path><path d="M483.4 510.7c-70.5 0-127.9-57.4-127.9-127.9s57.4-127.9 127.9-127.9 127.9 57.4 127.9 127.9-57.4 127.9-127.9 127.9z m0-209.3c-44.9 0-81.4 36.5-81.4 81.4s36.5 81.4 81.4 81.4c44.9 0 81.4-36.5 81.4-81.4s-36.6-81.4-81.4-81.4z" fill="#108EE9" p-id="2096"></path><path d="M433.2 563.8c0-51.5-0.2-103.1 0.1-154.6 0.2-36.1 18-57 48.2-57.2 32.1-0.2 54 22.6 54.2 57.8 0.4 57.4 0 114.8 0.2 172.2 0.1 30.5 7 38 39.5 40.9 65.3 5.7 130.6 11.1 195.9 16 41.3 3.1 57.7 20.5 49.6 58.2-16.4 76.4-34.4 152.6-51.1 228.9-4.5 20.8-18.2 30.5-39.7 31.4-29.5 1.3-59.1 2-88.7 2.1-83.2 0.3-166.4 0.2-249.6 0-32.3 0-42.7-6.7-52.8-34.7-27.9-77.3-55.5-154.7-83.2-232-8.1-22.5 4-47.3 27.4-56 22.2-8.2 52.7 2.8 62.4 24.2 11 24.4 21 49.3 30.1 74.3 5.4 14.8 13.6 26.7 31.6 24 19.2-3 26.3-16.8 26.2-34.4-0.5-53.7-0.4-107.4-0.3-161.1z" fill="#1195FE" p-id="2097"></path></svg>
          </div>
        </yhm-form-text-search>
        ...
        <yhm-form-select width="1" @click="businessClick()" v-if="isBusiness" default-txt="选择对应业务单" title="业务单据" :value="businessName" id="businessName" rule="R0000"></yhm-form-select>
      </template>
    </yhm-formbody>
    <div class="f_split"></div>
    <yhm-formbody >
      ...
      <template #control>
        ...
        <yhm-form-text placeholder=""  v-if="isReceiptType" title="收寄物内容" subtitle="" :value="itemContent" id="itemContent" rule="R0000"></yhm-form-text>
        <yhm-form-list-edit v-if="isDetails">
        ...
        <yhm-form-list-edit v-if="isInvoice">
          <template #title>发票详情</template>
          <template #operate>
            <yhm-commonbutton  value="添加文件" icon="btnAdd" @call="addDiscount"></yhm-commonbutton>
          </template>
          <template #listHead>
            <yhm-managerth style="width: 200px" title="发票编号"></yhm-managerth>
            <yhm-managerth style="width: 200px" title="发票金额"></yhm-managerth>
            <yhm-managerth style="width:100px" title="发票数量"></yhm-managerth>
            <yhm-managerth style="width: 310px" title="发票备注"></yhm-managerth>
            <yhm-managerth title="发票照片"></yhm-managerth>
            <yhm-managerth style="width: 40px" title="删除"></yhm-managerth>
          </template>
          <template #listBody>
            <tr v-for="(item,index) in detailsList" :key="index" :class="{InterlacBg:index%2!==0}">
              <yhm-form-td-textbox width="200" :list="detailsList" listid="detailsList" :value="item" id="name" rule="R0000"></yhm-form-td-textbox>
              <yhm-form-td-textbox width="200" :list="detailsList" listid="detailsList" :value="item" id="number" rule="R0000"></yhm-form-td-textbox>
              <yhm-form-td-textbox  width="100" :list="detailsList" listid="detailsList" :value="item" id="detailNumber" rule="R3000"></yhm-form-td-textbox>
              <yhm-form-td-textbox width="310" :list="detailsList" listid="detailsList" :value="item" id="remark"></yhm-form-td-textbox>
    ...
    <yhm-formbody >
      ...
      <template #control>
        <yhm-form-radio title="结算状态	" v-if="isReceivePayWay" @call="receivePayWayCall()" :select-list="receivePayWayList"  :value="receivePayWay" id="receivePayWay" rule="R0000"></yhm-form-radio>
        <yhm-form-zh-text-two tip-before="value" v-if="isNum"  :before="num" before-id="num" :after="weight" after-id="weight"  title="计费件数" subtitle=""  after-title="重量(KG)" after-width="140" afterRule="R0000" beforeRule="R0000"></yhm-form-zh-text-two>
        <yhm-form-text placeholder="" :no-edit="isAmountEdit" v-if="ifAmount" title="费用"  subtitle="" :value="amount" id="amount" ></yhm-form-text>
    ...
    <yhm-form-list-edit  class="duplicateAccount" :class="{isList:isList}">
      ...
      <template #title v-if="eNum==0">重复公司名称</template>
      <template #title v-if="eNum==1">重复联系人名称</template>
      <template #listHead>
        <yhm-managerth style="width: 170px;background: linear-gradient(0deg, #ec6603, #a24906);" title="公司名称"></yhm-managerth>
        <yhm-managerth style="width: 170px;background: linear-gradient(0deg, #ec6603, #a24906);" title="联系人"></yhm-managerth>
        <yhm-managerth style="width: 230px;background: linear-gradient(0deg, #ec6603, #a24906);" title="地址区域"></yhm-managerth>
        <yhm-managerth style="width: 100px;background: linear-gradient(0deg, #ec6603, #a24906);" title="手机号码"></yhm-managerth>
        <yhm-managerth style="width: 100px;background: linear-gradient(0deg, #ec6603, #a24906);" title="固定电话"></yhm-managerth>
      </template>
      <template #listBody >
        <tr v-for="(item,index) in UnitList" :key="index" :class="{InterlacBg:index%2!==0}" @click="selectUnit(item,eNum)">
...
<script>
  ...
  export default {
    ...
    data(){
      return{
        searchTableList:[
          //宽度  字体  颜色  背景色 字体位置 字体间距
          {width:'60px',fontSize:'',color:'',backgroundColor:'',textAlign:'',textIndent:'10px',key:'name'},
          {width:'100px',fontSize:'',color:'',backgroundColor:'',textAlign:'',textIndent:'',key:'phone'},
          {width:'350px',fontSize:'',color:'',backgroundColor:'',textAlign:'',textIndent:'',key:'nativePlace'},
          {width:'30px',fontSize:'',color:'',backgroundColor:'',textAlign:'',textIndent:'',key:'sexVal'}
        ],
        searchKey:0,//用来刷新组件状态
        searchLoading:false,
        searchList:[],
    ...
    methods:{
      ...
      searchClick(index,item){//用户选中了搜索结果 返回索引值以及选中数据
        this.otherPartyPersonID=item.id
        this.otherPartyPersonName=item.name
        this.otherPartyPhone=item.phone
        this.address=item.nativePlace
        this.$nextTick(()=>{
          this.verificationUnit(1)
        })
      },
      searchKeyDown(e){// 用户点击了按键 当前事件只会300毫秒返回一次 防止请求过于频繁
        this.searchLoading = true //请求前开启加载中的loading
        this.searchList = [] //清空上次搜索的内容
        this.ajaxJson({
          url:"/Basic/personManagerVague",
          data:{
            searchStr:this.otherPartyPersonName,
          },
          loading:"0",
          call:(data) => {
            this.searchLoading = false
            this.searchList = data.content //将搜索出的内容
          }
        })
      },
      invoiceImg(it){
    ...
    //隐藏发票图片
        ...
        // if (this.otherPartyPersonID!=''){
          if(this.businessType==1){
            this.$dialog.OpenWindow({
              width: 1050,
              height: 692,
              // url: '/insurancePolicyView?otherPartyPersonID='+this.otherPartyPersonID,
              url: '/insurancePolicyView',
              title: '选择对应业务单',
              closeCallBack: (data) => {
                this.businessName='车牌号:'+data.plate+'-----联系人：'+data.contactName
      ...
      personBlur(){
        if (this.otherPartyPersonName!=''){
          this.$dialog.OpenWindow({
            width: 950,
            height: 692,
            url: '/selectPerson?category=1&commonClientUse=1&personName='+this.otherPartyPersonName+'&parameter=0',
            title: '选择收件人',
            closeCallBack: (data) => {
              if (data) {
      ...
      verificationUnit(e){
        ...
        if((this.unit !=''&& e==0) || (this.otherPartyPersonID !='' && e==1)){
          this.ajaxJson({
            url: '/dailyoffice/addressBook/getManagerPC',
            data: params,
            loading:'0',
            call: (data) => {
      ...
      selectUnit(item,e){
        ...
        this.otherPartyPhone=item.otherPartyPhone
        this.otherPartyTelePhone=item.otherPartyTelePhone
        this.otherPartyPersonID=item.otherPartyPersonID
        this.otherPartyPersonName=item.otherPartyPersonName
    ...
    created () {
      ...
      this.setQuery2Value('businessID')
      ...
      //   }
       this.init({
        ...
        all: (data) => {
          ...
          this.businessType=data.businessTypePsd.value
        ...
        add: (data) => {
          ...
          if (this.category==1) {
            this.isBusin=true
            this.businessType='3' //业务单类型
            this.itemType='4'   //发票
            this.itemTypeCall()
            this.unit = JSON.parse(sessionStorage.purchaser);
            this.invoiceInformation = JSON.parse(sessionStorage.invoiceInformation);
            this.otherPartyPersonName = JSON.parse(sessionStorage.addressee);
            this.otherPartyPersonID = JSON.parse(sessionStorage.addresseeID);
            this.otherPartyPhone = JSON.parse(sessionStorage.addresseePhone);
            this.otherPartyTelePhone = JSON.parse(sessionStorage.addresseeTel);
            this.address = JSON.parse(sessionStorage.mailTitleAddress);
            this.regionName = JSON.parse(sessionStorage.mailTitle);
            this.regionID = JSON.parse(sessionStorage.mailTitleID);
            this.detailsList=[]
            let insertDate = new Date(accAdd(new Date().getTime(), accMul(this.detailsList.length, 1000)))
            for (let i in this.invoiceInformation) {
              this.detailsList.push({
                id: guid(),
                insertDate:formatTime(insertDate),
                ownerID: this.id,
                name:this.invoiceInformation[i].code,
                number:this.invoiceInformation[i].invoiceMoney,
                detailNumber:'1',
                remark: '',
                url:this.invoiceInformation[i].url,
              })
            }
            sessionStorage.removeItem('purchaser')
            sessionStorage.removeItem('invoiceInformation')
            sessionStorage.removeItem('addresseeID')
            sessionStorage.removeItem('addresseePhone')
            sessionStorage.removeItem('addresseeTel')
            sessionStorage.removeItem('mailTitleAddress')
            sessionStorage.removeItem('mailTitle')
            sessionStorage.removeItem('purchaser')
            sessionStorage.removeItem('mailTitleID')
            this.$nextTick(()=>{
              this.verificationUnit(0)
            })
          }
