  ...
  <div>
    <yhm-managerpage category="1">
      ...
      <template #navigationTab>
        <router-link class="menuTabDiv " :to="{path:'/home/invoiceManager'}">发票类型</router-link>
        <router-link class="menuTabDiv menuTabActive" :to="{path:'/home/feeSettlement/settleAccountManager'}">结算方式</router-link>  </template>
      <!--操作区-->
      <template #operate>
      ...
      <template #listHead>
        ...
        <yhm-managerth    title="结算名称" value="name" ></yhm-managerth>
  ...
  export default {
    ...
    methods:{
      ...
      initPageData (initValue) {
        ...
        this.init({
          initValue:initValue,
          url: '/Business/getSettleAccountManager',
          data:params,
          all:(data) =>{
            //不管是不是初始化都需要执行的代码
          },
