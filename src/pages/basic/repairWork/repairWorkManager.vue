  ...
  <div>
    <yhm-managerpage >
      ...
      <template #listHead>
        ...
        <yhm-managerth title="车主" value="carOwner"></yhm-managerth>
        <yhm-managerth title="车辆类型" value="categoryVal"></yhm-managerth>
        <yhm-managerth title="所属类型" value="assortVal"></yhm-managerth>
        ...
        <yhm-managerth title="车架号" value="frameNumber"></yhm-managerth>
        <yhm-managerth title="发动机号" value="engineNumber"></yhm-managerth>
        <yhm-managerth style="width:80px;" title="品牌" value="brand"></yhm-managerth>
        <yhm-managerth style="width:80px;" title="车型" value="model"></yhm-managerth>
        <yhm-managerth style="width:80px;" title="车辆版本" value="version"></yhm-managerth>

        <yhm-managerth style="width:120px;" title="登记日期" value="registerDate"></yhm-managerth>
      ...
      <template #listBody>
        <tr :class="[{twinkleBg: item.id==lastData},{InterlacBg:index%2!=0}]" v-for="(item,index) in content" :key="index">
          ...
          <yhm-manager-td :value="item.frameNumber"></yhm-manager-td>
          <yhm-manager-td :value="item.engineNumber"></yhm-manager-td>
  ...
  export default {
    ...
    methods:{
      ...
      initPageData (initValue) {
        ...
        this.init({
          initValue:initValue,
          url: '/Basic/getRepairWorkManager',
          data:params,
          all:(data) =>{
            //不管是不是初始化都需要执行的代码
          },
