  ...
  <div>
    <yhm-managerpage category="1">
      ...
      <template #navigationTab>
        ...
        <router-link class="menuTabDiv menuTabActive" :to="{path:'/home/information/handlePersonManager'}">办理人员</router-link>
      </template>
      <!--操作区-->
      <template #operate>
      ...
      <template #listHead>
        ...
        <yhm-managerth title="业务员" value="salesman"></yhm-managerth>
        <yhm-managerth title="出单员"  value="billClerk"></yhm-managerth>
        <yhm-managerth title="收银员" value="cashier"></yhm-managerth>
      ...
      <template #listBody>
        <tr :class="[{twinkleBg: item.id==lastData},{InterlacBg:index%2!=0}]" v-for="(item,index) in content" :key="index">
          ...
          <yhm-manager-td :value="item.salesman"></yhm-manager-td>
          <yhm-manager-td :value="item.billClerk"></yhm-manager-td>
          <yhm-manager-td :value="item.cashier"></yhm-manager-td>
  ...
  export default {
    ...
    methods:{
      ...
      initPageData (initValue) {
        ...
        this.init({
          initValue:initValue,
          url: '/Basic/getHandlePersonManager',
          data:params,
          all:(data) =>{
            //不管是不是初始化都需要执行的代码
          },
