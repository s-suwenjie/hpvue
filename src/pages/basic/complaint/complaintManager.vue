  ...
  <div>
    <yhm-managerpage category="1">
      ...
      <template #navigationTab>
        <router-link class="menuTabDiv menuTabActive" :to="{path:'/home/complaintManager'}">客户投诉</router-link>
       </template>
      <!--操作区-->
      <template #operate>
      ...
      <template #listHead>
        ...
        <yhm-managerth  title="投诉编码" value="code"></yhm-managerth>
        <yhm-managerth  title="投诉结果名称" value="name"></yhm-managerth>
  ...
  export default {
    ...
    methods:{
      ...
      initPageData (initValue) {
        ...
        this.init({
          initValue:initValue,
          url: '/Business/getComplaintManager',
          data:params,
          all:(data) =>{
            //不管是不是初始化都需要执行的代码
          },
