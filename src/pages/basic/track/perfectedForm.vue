  ...
  <div class="f_main">
    <yhm-formbody>
      ...
      <template #control>
        ...
        <yhm-form-text placeholder="" tip="value"  title="联系人" subtitle="身份证号" :value="idNo" id="idNo"></yhm-form-text>
        <yhm-form-select  title="车牌号" tip="value"   @click="plateEvent" :value="plate" id="plate" :rule="isRule"></yhm-form-select>
        <yhm-form-select  title="车主" tip="value" @click="carOwnerEvent" :value="carOwner" id="carOwner" :rule="isRule"  ></yhm-form-select>
        <yhm-form-text placeholder="" tip="value"  title="车主" subtitle="身份证号" :value="carOwnerIDNO" id="carOwnerIDNO"></yhm-form-text>
      ...
      save () {
        if (this.validator()) {
          let params = {
            ...
            carOwnerIDNO:this.carOwnerIDNO,
              ...
              if (data.type === 0) {
                if(this.state==1||this.state==2 ||this.state==3) {
                  ...
                  let paramData = {
                    ...
                    remark: this.remark,
                    level: 0,
                    nextDate: this.forceEndDate,
                    planDate: this.businessEndDate,
                    trackPersonID: this.principalID,
                    ownerID: this.id,
                  }
                  this.ajaxJson({
