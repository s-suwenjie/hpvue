  ...
  <div class="f_main">
    <yhm-formbody>
      ...
      <template #control>
        ...
        <yhm-form-text placeholder=""  @repeatverify="nameVerifyEvent"  ref="name" title="发票名称" subtitle="" :value="name" id="name" rule="R0000"></yhm-form-text>
        <yhm-form-text placeholder="" title="税率" subtitle="" :value="taxRate" id="taxRate" rule="R0007"></yhm-form-text>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      nameVerifyEvent(){
        this.ajaxJson({
          url:"/Business/isExistInvoiceByName",
          data:{
            id:this.id,
            name:this.name
          },
