      ...
      <template #listBody>
        <tr v-for="(item,index) in content" :key="index" :class="[{twinkleBg: item.id==lastData},{InterlacBg:index%2!=0}]">
          ...
          <yhm-manager-td-operate>
            <yhm-manager-td-operate-button v-show="item.state === '-1' && item.isDelay === '0'" @click="delayEvent(item)" value="延期核销" icon="i-delay" color="#49a9ea"></yhm-manager-td-operate-button>
