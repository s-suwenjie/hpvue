        ...
        <div style="display:flex;align-items: center;">
          <div style="margin-right: 30px">
            <div style="width: 100%;display: flex;justify-content: space-between;align-items: center;">
              <yhm-form-date title="开始日期" width="230" :max="endDateCustom" :error-show="false" @call="dateClick(startDateCustom,endDateCustom)" :value="startDateCustom" id="startDateCustom"></yhm-form-date>
              <yhm-form-date title="结束日期" width="230" :error-show="false" @call="dateClick(startDateCustom,endDateCustom)" :value="endDateCustom" id="endDateCustom"></yhm-form-date>
          ...
          <div style="background: #c5daeb;margin-right: 2px;">
            <table style="width:250px;height: 50px;" >
              ...
              <tr  style="background: #fff;box-sizing: border-box;">
                ...
                <td v-html="tenThousandFormatShow(totalMoney+'')" style="color: #49a9ea;text-align: right;box-sizing: border-box;padding-right:10px "></td>
              </tr>
              </tbody>
            </table>
          </div>
      ...
      <template #content>
        <yhm-view-tab-list :customize="true" >
          <template #listHead>
            ...
            <yhm-managerth title="待结金额"></yhm-managerth>
            <yhm-managerth title="合计金额"></yhm-managerth>
  ...
  export default {
    ...
    data(){
      return{
        ...
        startDateCustom:formatDate(new Date()),//启用日期
        endDateCustom:formatDate(new Date()),//结束日期
        totalMoney:'',//总计金额
        pager: { // 分页数据
          total: '', // 数据总条数
          pageSize: 5, // 单页数据条数
