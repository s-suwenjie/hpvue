<template>
  <div class="f_main">
    <yhm-formbody>
      ...
      <template #control>
        <yhm-form-text :show="isInvoiceNum" title="发票号码" :value="invoiceNum" id="invoiceNum" rule="R1100"></yhm-form-text>
        <yhm-form-text :show="isInvoiceFir" :title="isFirWord?'首张':''" subtitle="发票号码" :value="invoiceFir" id="invoiceFir" rule="R1100"></yhm-form-text>
        <yhm-form-text :show="isInvoiceSheet" title="发票张数" :value="invoiceSheet" id="invoiceSheet" rule="R1300" :max-length="3"></yhm-form-text>
        <yhm-form-text :show="isInvoiceLast" title="末张" subtitle="发票号码" :value="invoiceLast" id="invoiceLast" rule="R1100"></yhm-form-text>
      </template>
    </yhm-formbody>
