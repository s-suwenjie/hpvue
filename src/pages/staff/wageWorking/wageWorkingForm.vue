  ...
  <div  class="f_main">
    <yhm-formbody>
      ...
      <template #control>
        ...
        <yhm-form-radio title="工龄工资" subtitle="基数级别" :select-list="categoryPsd" :value="category" id="category" rule="R0000" width="1"></yhm-form-radio>
