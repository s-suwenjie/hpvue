  ...
  <div  class="f_main">
    <yhm-formbody>
      ...
      <template #control>
        ...
        <yhm-form-radio title="工资级别" :select-list="categoryPsd" :value="category" id="category" rule="R0000" width="1"></yhm-form-radio>
...
<script>
  ...
  export default {
    ...
    created(){
      let params={}
      this.init({
        url: '/finance/wageBasic/initForm',
        data: params,
        all: (data) => {
