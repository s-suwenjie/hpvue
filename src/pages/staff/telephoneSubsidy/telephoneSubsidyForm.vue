  ...
  <div  class="f_main">
    <yhm-formbody>
      ...
      <template #control>
        ...
        <yhm-form-radio title="话费补" subtitle="助级别" :select-list="categoryPsd" :value="category" id="category" rule="R0000" width="1"></yhm-form-radio>
...
<script>
  ...
  export default {
    ...
    created(){
      let params={}
      this.init({
        url: '/finance/telephoneSubsidy/initForm',
        data: params,
        all: (data) => {
    ...
    methods:{
      save(){
        ...
        if(a){
          ...
          this.ajaxJson({
            url: '/finance/telephoneSubsidy/save',
            data: param,
            call: (data) => {
              if(data.type===0){
