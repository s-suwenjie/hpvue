<template>
  <div class="chooseBtnBox lplRadio">
    ...
    <div class="chooseContent">
      <button v-for="(item,index) in content.list" :key="index" @click="clickEvent($event,item.num)" class="btn" type="button" :class="{choice:item.num === content.value}">{{item.showName}}</button>
