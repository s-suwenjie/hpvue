    ...
    <div class="fc_box">
      ...
      <div class="c_main">
        ...
        <div class="c_box" @mouseout="mouseoutEvent" @mouseover="mouseoverEvent" :class="{c_error:error,c_hover:mouseStyle,c_focus:focusStyle,c_disable:noEdit}">
          ...
          <input v-if="!topnoEdit" @focus="focusEvent" @blur="blurEvent" class="c_after fs14 mr10" :style="getAfterWidth" :placeholder="afterPlaceholder" v-model="afterVal" />
          <div v-if="topnoEdit" class="c_after fs14 mr10 c_disable_div" :style="getAfterWidth">{{afterVal}}</div>

          <div style="display: inline-block;" :class="{'bordertop':beforetop}">
