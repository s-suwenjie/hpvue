...
<!--        <yhm-view-control title="发生日期" :content="workDate" type="date"></yhm-view-control>-->
        ...
        <yhm-view-control title="实际金额" type="money" :content="actualMoney"  color="#f00"></yhm-view-control>
        ...
        <yhm-view-control title="发票金额" type="money" :content="invoiceMoney" v-if="noInvoice" color="#4BB414"></yhm-view-control>
      ...
      <template #content>
        <yhm-view-tab-list :customize="true" :pager="false" v-show="tabState[0].select">
          <template #listHead>
            ...
            <yhm-managerth style="width: 200px" title="开票日期"></yhm-managerth>
            <yhm-managerth style="width: 140px" title="类型"></yhm-managerth>
            <yhm-managerth style="width: 140px" title="发票张数"></yhm-managerth>
            <yhm-managerth style="width: 140px" title="票面金额"></yhm-managerth>
            <yhm-managerth style="width: 100px" title="实报金额"></yhm-managerth>
