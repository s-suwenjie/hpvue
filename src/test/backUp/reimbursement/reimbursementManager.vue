  ...
  <div>
    <yhm-managerpage category="1">
      ...
      <template #navigationTab>
        ...
        <div class="menuTabActive">报销申请
        </div>
        <router-link class="menuTabDiv " :to="{path:'/home/paymentApply'}">付款申请
      ...
      <template #listBody>
        <tr :class="[{twinkleBg: item.id==lastData},{InterlacBg:index%2!=0}]" v-for="(item,index) in content" :key="index">
          ...
          <yhm-manager-td-date :value="item.workDate==''?'----------':item.workDate"></yhm-manager-td-date>
